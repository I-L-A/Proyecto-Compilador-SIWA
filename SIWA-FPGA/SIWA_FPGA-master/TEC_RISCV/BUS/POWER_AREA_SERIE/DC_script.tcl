...
compile_ultra  -no_autoungroup > reports/compile_ultra_output.log
uniquify > reports/uniquify_output.log

#############################################
# report_generation
#############################################

write -format verilog -hierarchy -output reports/mapped_gate_level_netlist.v; 
write -hierarchy -format ddc -output db/mapped_gate_level_netlist.ddc;
write_sdc ./db/mapped_gate_level_netlist.sdc
