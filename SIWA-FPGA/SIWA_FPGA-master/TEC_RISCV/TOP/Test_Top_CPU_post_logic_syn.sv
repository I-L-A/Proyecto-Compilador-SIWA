`define DEBUG
`timescale 1ns/10ps
`include "../TOP/Tec_Riscv_pads_syn.v"
//`include "../TOP/topcore_tecriscv.sv"
//`include "../TOP/Status.sv"
`include "../TOP/XSPRAMLP_2048X32_M8P.sv"
`include "../TOP/IS25WP032D.v"
`include "/mnt/vol_NFS_Zener/tools/synopsys/pdks/xh018-ams/XFAB_snps_CustomDesigner_kit_v2_1_0/xh018/diglibs/IO_CELLS_F3V/v2_1/verilog/v2_1_0/IO_CELLS_F3V.v"
