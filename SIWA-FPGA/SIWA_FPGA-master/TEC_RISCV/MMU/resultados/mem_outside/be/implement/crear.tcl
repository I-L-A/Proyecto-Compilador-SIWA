...
source /mnt/vol_NFS_Zener/WD_ESPEC/fonsecam/high_density/Back_end/implement/user.tcl
...
create_mw_lib -technology $tech_home/xh018/synopsys/v6_3/techMW/v6_3_1_1/xh018-synopsys-techMW-v6_3_1_1/$TECH_FILE  -mw_reference_library $MW_REFERENCE_LIB_DIRS $mw_design_library_name
...
import_designs -format verilog {/mnt/vol_NFS_Zener/WD_ESPEC/fonsecam/high_density/Back_end/source/controlador.v} -top controlador
...
read_sdc {/mnt/vol_NFS_Zener/WD_ESPEC/fonsecam/high_density/Back_end/source/controlador.sdc}


set_fp_strategy -unit_tile_name "hdll"

create_floorplan -core_utilization 0.9 -left_io2core 40 -right_io2core 40 -top_io2core 40 -bottom_io2core 40
...
#Reloj
set_clock_tree_options -clock_trees CLK_sys -insert_boundary_cell true -ocv_clustering true -buffer_relocation true -buffer_sizing true -gate_relocation true -gate_sizing true
...
save_mw_cel  -design "controlador.CEL";

write_verilog /mnt/vol_NFS_Zener/WD_ESPEC/fonsecam/high_density/Back_end/db/be/controlador/controlador.v
...
extract_rc
 ...
 write_parasitics -output {/mnt/vol_NFS_Zener/WD_ESPEC/fonsecam/high_density/Back_end/db/be/controlador/controlador.spef}
 write_sdf /mnt/vol_NFS_Zener/WD_ESPEC/fonsecam/high_density/Back_end/db/be/controlador/controlador.sdf
 write_sdc /mnt/vol_NFS_Zener/WD_ESPEC/fonsecam/high_density/Back_end/db/be/controlador/controlador.sdc
 write_def -output "/mnt/vol_NFS_Zener/WD_ESPEC/fonsecam/high_density/Back_end/db/be/controlador/controlador.def"


 
set string_replace "sed -i \"s/endmodule/initial\ \\\$sdf\_annotate\(\\\"controlador.sdf\\\"\)\\\\; \\n endmodule/g\" /mnt/vol_NFS_Zener/WD_ESPEC/fonsecam/high_density/Back_end/db/be/controlador/controlador.v"


save_mw_cel -as controlador_routing


report_power -hierarchy > /mnt/vol_NFS_Zener/WD_ESPEC/fonsecam/high_density/Back_end/reports/controlador_power.txt
report_area -hierarchy > /mnt/vol_NFS_Zener/WD_ESPEC/fonsecam/high_density/Back_end/reports/controlador_area.txt
report_cell > /mnt/vol_NFS_Zener/WD_ESPEC/fonsecam/high_density/Back_end/reports/controlador_cell.txt
report_qor > /mnt/vol_NFS_Zener/WD_ESPEC/fonsecam/high_density/Back_end/reports/controlador_qor.txt
report_timing > /mnt/vol_NFS_Zener/WD_ESPEC/fonsecam/high_density/Back_end/reports/controlador_timing.txt
report_port > /mnt/vol_NFS_Zener/WD_ESPEC/fonsecam/high_density/Back_end/reports/controlador_port.txt
