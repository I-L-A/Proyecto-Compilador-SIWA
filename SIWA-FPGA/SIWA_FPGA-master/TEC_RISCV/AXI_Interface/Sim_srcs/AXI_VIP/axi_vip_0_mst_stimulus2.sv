...
import AXI_Master_1_pkg::*;

module axi_master_1_mst_stimulus();
  ...
  ************************************************************************************************/
  ...
  initial begin
    ...
    ***********************************************************************************************/
    agent = new("master vip agent",DUT.Master_1.inst.IF);
...
//////////Escritura del segundo esclavo///////////////////////
        mtestWID = 0;//$urandom_range(0,(1<<(0)-1)); 
        mtestWADDR = 32'h40001123;//0;
        mtestWBurstLength = 0;
...
//////////Lectura del primer esclavo///////////////////////
        ...
        mtestRADDR = 32'h40000234;//$urandom_range(0,(1<<(32)-1));
        mtestRBurstLength = 0;
...
//////////Lectura y escritura del primer esclavo///////////////////////
    mtestWID = 0;//$urandom_range(0,(1<<(0)-1)); 
    mtestWADDR = 32'h40000765;//0;
    mtestWBurstLength = 0;
    mtestWDataSize = xil_axi_size_t'(xil_clog2((32)/8));
    mtestWBurstType = XIL_AXI_BURST_TYPE_INCR;
    mtestWData = $urandom();
 ...
 //////////Lectura del primer esclavo///////////////////////
     mtestRID = 0;//$urandom_range(0,(1<<(0)-1));
     mtestRADDR = 32'h40000124;//$urandom_range(0,(1<<(32)-1));
     mtestRBurstLength = 0;
     mtestRDataSize = xil_axi_size_t'(xil_clog2((32)/8)); 
     mtestRBurstType = XIL_AXI_BURST_TYPE_INCR;
     single_read_transaction_api("single read with api",
