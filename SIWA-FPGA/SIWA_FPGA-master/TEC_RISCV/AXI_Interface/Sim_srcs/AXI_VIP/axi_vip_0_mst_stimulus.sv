...
module axi_master_0_mst_stimulus();
  ...
  ************************************************************************************************/
  ...
  initial begin
    ...
    * out. Pass this path to the new function.
    //
    XilinxAXIVIP: Found at Path: axi_vip_0_exdes_basic_mst_active__slv_comb.DUT.Master_0.inst
    XilinxAXIVIP: Found at Path: axi_vip_0_exdes_basic_mst_active__slv_comb.DUT.Master_1.inst
    XilinxAXIVIP: Found at Path: axi_vip_0_exdes_basic_mst_active__slv_comb.DUT.Slave_0.inst
    XilinxAXIVIP: Found at Path: axi_vip_0_exdes_basic_mst_active__slv_comb.DUT.Slave_1.inst
    ***********************************************************************************************/
    agent = new("master vip agent",DUT.Master_0.inst.IF);
    ...
    fork                               // Fork process of write/read transaction generation                    
      ...
      begin  
//////////Escritura del primer esclavo///////////////////////
        mtestWID = 0;//$urandom_range(0,(1<<(0)-1)); 
        mtestWADDR = 32'h40000123;//0;
        mtestWBurstLength = 0;
...
//////////Lectura del segundo esclavo///////////////////////
        mtestRID = 0;//$urandom_range(0,(1<<(0)-1));
        mtestRADDR = 32'h40001234;//$urandom_range(0,(1<<(32)-1));
        mtestRBurstLength = 0;
...
//////////Lectura y escritura del segundo esclavo///////////////////////
    mtestWID = 0;//$urandom_range(0,(1<<(0)-1)); 
    mtestWADDR = 32'h40001765;//0;
    mtestWBurstLength = 0;
    mtestWDataSize = xil_axi_size_t'(xil_clog2((32)/8));
    mtestWBurstType = XIL_AXI_BURST_TYPE_INCR;
    mtestWData = $urandom();
    ...
    mtestRID = 0;//$urandom_range(0,(1<<(0)-1));
    mtestRADDR = 32'h40001765;//$urandom_range(0,(1<<(32)-1));
    mtestRBurstLength = 0;
    mtestRDataSize = xil_axi_size_t'(xil_clog2((32)/8)); 
    mtestRBurstType = XIL_AXI_BURST_TYPE_INCR;
    single_read_transaction_api("single read with api",
     ...
     agent.wait_drivers_idle();           // Wait driver is idle 
     #50                            
 //////////Lectura del primer esclavo///////////////////////
     mtestRID = 0;//$urandom_range(0,(1<<(0)-1));
     mtestRADDR = 32'h40000123;//$urandom_range(0,(1<<(32)-1));
     mtestRBurstLength = 0;
     mtestRDataSize = xil_axi_size_t'(xil_clog2((32)/8)); 
     mtestRBurstType = XIL_AXI_BURST_TYPE_INCR;
     single_read_transaction_api("single read with api",
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
//Inicia la especificación de las tareas que se pueden llamar en la estimulación del maestro//////////////
/////////////////////////////////////////////////////////////////////////////////////////////////////////
