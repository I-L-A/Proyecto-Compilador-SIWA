...
//`include "axi_vip_0_mst_stimulus2.sv"
//`include "axi_vip_0_slv_basic_stimulus2.sv"

module axi_vip_0_exdes_basic_mst_active__slv_comb(
  );
  ...
  axi_master_0_mst_stimulus mst();
  axi_slave_0_slv_stimulus slv();
  axi_master_1_mst_stimulus mst2();
  axi_slave_1_slv_stimulus slv2();
