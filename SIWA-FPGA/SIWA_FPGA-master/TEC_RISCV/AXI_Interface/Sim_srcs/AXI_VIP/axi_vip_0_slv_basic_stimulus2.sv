...
import AXI_Slave_1_pkg::*;

module axi_slave_1_slv_stimulus(
  );
  ...
  *************************************************************************************************/
  ...
  initial begin
    ...
    * out. Pass this path to the new function. 
    XilinxAXIVIP: Found at Path: axi_vip_0_exdes_basic_mst_active__slv_comb.DUT.VIP.axi_vip_0.inst
    XilinxAXIVIP: Found at Path: axi_vip_0_exdes_basic_mst_active__slv_comb.DUT.VIP.axi_vip_1.inst
    XilinxAXIVIP: Found at Path: axi_vip_0_exdes_basic_mst_active__slv_comb.DUT.VIP.axi_vip_2.inst
    XilinxAXIVIP: Found at Path: axi_vip_0_exdes_basic_mst_active__slv_comb.DUT.VIP.axi_vip_3.inst 
    ***********************************************************************************************/
    agent = new("slave vip agent",DUT.Slave_1.inst.IF);
