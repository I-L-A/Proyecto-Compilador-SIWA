...
set mw_path "$proy_home/$proy_name.mw"
...
write -hierarchy -format ddc -output ./mapped_gate_level_netlist.ddc;
write_sdc ./mapped_gate_level_netlist.sdc
...
report_timing -path_type full -nets -input_pins -capacitance -transition_time -max_paths 10 -significant_digits 3 
